...
func (ctx *Ctx) callActionData(action string, params Params) (gjson.Result, error) {
...
func (ctx *Ctx) SendGroupMessage(groupID int64, message interface{}) (int64, error) {
	data, err := ctx.callActionData("send_group_msg", Params{ // 调用并保存返回值
		"group_id": groupID,
		"message":  message,
	})
	if err != nil {
...
func (ctx *Ctx) SendPrivateMessage(userID int64, message interface{}) (int64, error) {
	data, err := ctx.callActionData("send_private_msg", Params{
		"user_id": userID,
		"message": message,
	})
	if err != nil {
...
//
//nolint:interfacer
func (ctx *Ctx) DeleteMessage(messageID interface{}) error {
	return ctx.callActionOnly("delete_msg", Params{
...
//
//nolint:interfacer
func (ctx *Ctx) GetMessage(messageID interface{}, nologreply ...bool) (Message, error) {
	params := Params{
		"message_id": messageID,
	}
	...
	rsp, err := ctx.callActionData("get_msg", params)
	if err != nil {
		return Message{}, err
	}
	m := Message{
...
func (ctx *Ctx) GetForwardMessage(id string) (gjson.Result, error) {
...
func (ctx *Ctx) SendLike(userID int64, times int) error {
	return ctx.callActionOnly("send_like", Params{
		"user_id": userID,
		"times":   times,
	})
}
...
func (ctx *Ctx) SetGroupKick(groupID, userID int64, rejectAddRequest bool) error {
	return ctx.callActionOnly("set_group_kick", Params{
		"group_id":           groupID,
		"user_id":            userID,
...
// https://github.com/botuniverse/onebot-11/blob/master/api/public.md#set_group_kick-%E7%BE%A4%E7%BB%84%E8%B8%A2%E4%BA%BA
func (ctx *Ctx) SetThisGroupKick(userID int64, rejectAddRequest bool) error {
...
func (ctx *Ctx) SetGroupBan(groupID, userID, duration int64) error {
	return ctx.callActionOnly("set_group_ban", Params{
		"group_id": groupID,
		"user_id":  userID,
		"duration": duration,
	})
...
// https://github.com/botuniverse/onebot-11/blob/master/api/public.md#set_group_ban-%E7%BE%A4%E7%BB%84%E5%8D%95%E4%BA%BA%E7%A6%81%E8%A8%80
func (ctx *Ctx) SetThisGroupBan(userID, duration int64) error {
...
func (ctx *Ctx) SetGroupWholeBan(groupID int64, enable bool) error {
	return ctx.callActionOnly("set_group_whole_ban", Params{
		"group_id": groupID,
		"enable":   enable,
	})
}
...
// https://github.com/botuniverse/onebot-11/blob/master/api/public.md#set_group_whole_ban-%E7%BE%A4%E7%BB%84%E5%85%A8%E5%91%98%E7%A6%81%E8%A8%80
func (ctx *Ctx) SetThisGroupWholeBan(enable bool) error {
	return ctx.SetGroupWholeBan(ctx.Event.GroupID, enable)
}

// SetGroupAdmin 群组设置管理员
// https://github.com/botuniverse/onebot-11/blob/master/api/public.md#set_group_whole_ban-%E7%BE%A4%E7%BB%84%E5%85%A8%E5%91%98%E7%A6%81%E8%A8%80
func (ctx *Ctx) SetGroupAdmin(groupID, userID int64, enable bool) error {
	return ctx.callActionOnly("set_group_admin", Params{
		"group_id": groupID,
		"user_id":  userID,
		"enable":   enable,
	})
...
// https://github.com/botuniverse/onebot-11/blob/master/api/public.md#set_group_whole_ban-%E7%BE%A4%E7%BB%84%E5%85%A8%E5%91%98%E7%A6%81%E8%A8%80
func (ctx *Ctx) SetThisGroupAdmin(userID int64, enable bool) error {
...
func (ctx *Ctx) SetGroupAnonymous(groupID int64, enable bool) error {
	return ctx.callActionOnly("set_group_anonymous", Params{
		"group_id": groupID,
		"enable":   enable,
	})
}
...
// https://github.com/botuniverse/onebot-11/blob/master/api/public.md#set_group_anonymous-%E7%BE%A4%E7%BB%84%E5%8C%BF%E5%90%8D
func (ctx *Ctx) SetThisGroupAnonymous(enable bool) error {
...
func (ctx *Ctx) SetGroupCard(groupID, userID int64, card string) error {
	return ctx.callActionOnly("set_group_card", Params{
		"group_id": groupID,
		"user_id":  userID,
		"card":     card,
	})
...
// https://github.com/botuniverse/onebot-11/blob/master/api/public.md#set_group_card-%E8%AE%BE%E7%BD%AE%E7%BE%A4%E5%90%8D%E7%89%87%E7%BE%A4%E5%A4%87%E6%B3%A8
func (ctx *Ctx) SetThisGroupCard(userID int64, card string) error {
...
func (ctx *Ctx) SetGroupName(groupID int64, groupName string) error {
	return ctx.callActionOnly("set_group_name", Params{
		"group_id":   groupID,
...
func (ctx *Ctx) SetGroupLeave(groupID int64, isDismiss bool) error {
	return ctx.callActionOnly("set_group_leave", Params{
		"group_id":   groupID,
...
// https://github.com/botuniverse/onebot-11/blob/master/api/public.md#set_group_leave-%E9%80%80%E5%87%BA%E7%BE%A4%E7%BB%84
func (ctx *Ctx) SetThisGroupLeave(isDismiss bool) error {
...
func (ctx *Ctx) SetGroupSpecialTitle(groupID, userID int64, specialTitle string) error {
	return ctx.callActionOnly("set_group_special_title", Params{
		"group_id":      groupID,
		"user_id":       userID,
...
// https://github.com/botuniverse/onebot-11/blob/master/api/public.md#set_group_special_title-%E8%AE%BE%E7%BD%AE%E7%BE%A4%E7%BB%84%E4%B8%93%E5%B1%9E%E5%A4%B4%E8%A1%94
func (ctx *Ctx) SetThisGroupSpecialTitle(userID int64, specialTitle string) error {
...
func (ctx *Ctx) SetFriendAddRequest(flag string, approve bool, remark string) error {
	return ctx.callActionOnly("set_friend_add_request", Params{
		"flag":    flag,
		"approve": approve,
		"remark":  remark,
	})
...
func (ctx *Ctx) SetGroupAddRequest(flag string, subType string, approve bool, reason string) error {
	return ctx.callActionOnly("set_group_add_request", Params{
		"flag":     flag,
		"sub_type": subType,
		"approve":  approve,
		"reason":   reason,
...
func (ctx *Ctx) GetGroupInfo(groupID int64, noCache bool) (Group, error) {
	rsp, err := ctx.callActionData("get_group_info", Params{
		"group_id": groupID,
		"no_cache": noCache,
	})
	if err != nil {
	...
	group := Group{}
	if err = json.Unmarshal([]byte(rsp.Raw), &group); err != nil {
		return Group{}, err
	}
	return group, nil
}
...
func (ctx *Ctx) GetRecord(file string, outFormat string) (gjson.Result, error) {
...
func (ctx *Ctx) GetImage(file string) (gjson.Result, error) {
...
func (ctx *Ctx) SetGroupPortrait(groupID int64, file string) error {
	return ctx.callActionOnly("set_group_portrait", Params{
		"group_id": groupID,
		"file":     file,
	})
}
...
// https://github.com/Mrs4s/go-cqhttp/blob/master/docs/cqhttp.md#%E8%AE%BE%E7%BD%AE%E7%BE%A4%E5%A4%B4%E5%83%8F
func (ctx *Ctx) SetThisGroupPortrait(file string) error {
...
func (ctx *Ctx) GetGroupMessageHistory(groupID, messageID, count int64, reverseOrder bool) (gjson.Result, error) {
...
func (ctx *Ctx) GetLatestGroupMessageHistory(groupID, count int64, reverseOrder bool) (gjson.Result, error) {
	return ctx.callActionData("get_group_msg_history", Params{
		"group_id":     groupID,
		"count":        count,        // 兼容napcat
		"reverseOrder": reverseOrder, // 兼容napcat
...
func (ctx *Ctx) GetThisGroupMessageHistory(messageID, count int64, reverseOrder bool) (gjson.Result, error) {
...
func (ctx *Ctx) GetLatestThisGroupMessageHistory(count int64, reverseOrder bool) (gjson.Result, error) {
...
func (ctx *Ctx) SendGuildChannelMessage(guildID, channelID string, message interface{}) (string, error) {
	data, err := ctx.callActionData("send_guild_channel_msg", Params{
		"guild_id":   guildID,
...
func (ctx *Ctx) GetGroupFileURL(groupID, busid int64, fileID string) (string, error) {
	data, err := ctx.callActionData("get_group_file_url", Params{
		"group_id": groupID,
		"file_id":  fileID,
		"busid":    busid,
	})
...
func (ctx *Ctx) SetMessageEmojiLike(messageID interface{}, emojiID rune) error {
	data, err := ctx.callActionData("set_msg_emoji_like", Params{
		"message_id": messageID,
...
func (ctx *Ctx) SetGroupSign(groupID int64) error {
	return ctx.callActionOnly("set_group_sign", Params{
		"group_id": groupID,
	})
}
...
func (ctx *Ctx) GroupPoke(groupID, userID int64) error {
	return ctx.callActionOnly("group_poke", Params{
		"group_id": groupID,
		"user_id":  userID,
	})
}
...
func (ctx *Ctx) FriendPoke(userID int64) error {
	return ctx.callActionOnly("friend_poke", Params{
		"user_id": userID,
	})
}
...
//
// c
func (ctx *Ctx) ArkSharePeer(userID, groupID string) (string, error) {
	data, err := ctx.callActionData("ArkSharePeer", Params{
		"user_id":  userID,
		"group_id": groupID,
	})
	if err != nil {
	...
	return data.Get("arkJson").String(), nil
}
...
func (ctx *Ctx) ArkShareGroup(groupID string) (string, error) {
	data, err := ctx.callActionData("ArkShareGroup", Params{
		"group_id": groupID,
	})
	if err != nil {
		return "", err
...
func (ctx *Ctx) GetRobotUinRange() (start, end int64, err error) {
	data, err := ctx.callActionData("get_robot_uin_range", Params{})
	if err != nil {
		return 0, 0, err
	}
	arr := data.Array()
...
func (ctx *Ctx) SetOnlineStatus(status, extStatus, batteryStatus int) error {
	return ctx.callActionOnly("set_online_status", Params{
		"status":         status,
...
func (ctx *Ctx) GetFriendsWithCategory() (gjson.Result, error) {
...
func (ctx *Ctx) TranslateEn2Zh(words []string) ([]string, error) {
	data, err := ctx.callActionData("translate_en2zh", Params{
		"words": words,
	})
	if err != nil {
		return nil, err
...
func (ctx *Ctx) SendForwardMessage(messageType string, userID, groupID int64, messages message.Message) (messageID int64, resID string, err error) {
	data, err := ctx.callActionData("send_forward_msg", Params{
	...
	return data.Get("message_id").Int(), data.Get("res_id").String(), nil
}
...
func (ctx *Ctx) MarkPrivateMessageAsRead(userID int64) error {
	return ctx.callActionOnly("mark_private_msg_as_read", Params{
		"user_id": userID,
	})
}
...
func (ctx *Ctx) MarkGroupMessageAsRead(groupID int64) error {
	return ctx.callActionOnly("mark_group_msg_as_read", Params{
		"group_id": groupID,
	})
}
...
func (ctx *Ctx) GetFriendMessageHistory(userID, messageSeq string, count int, reverseOrder bool) (gjson.Result, error) {
...
func (ctx *Ctx) CreateCollection() (gjson.Result, error) {
...
func (ctx *Ctx) GetCollectionList() (gjson.Result, error) {
...
func (ctx *Ctx) SetSelfLongNick(longNick string) (gjson.Result, error) {
...
func (ctx *Ctx) GetRecentContact(count int) (gjson.Result, error) {
...
func (ctx *Ctx) MarkAllAsRead() error {
	return ctx.callActionOnly("_mark_all_as_read", Params{})
}
...
func (ctx *Ctx) GetProfileLike() (gjson.Result, error) {
...
func (ctx *Ctx) FetchCustomFace(count int) (gjson.Result, error) {
...
func (ctx *Ctx) GetAIRecord(character string, groupID int64, text string) (string, error) {
	data, err := ctx.callActionData("get_ai_record", Params{
		"character": character,
		"group_id":  groupID,
		"text":      text,
	})
...
func (ctx *Ctx) GetAICharacters(groupID int64, chatType int) (gjson.Result, error) {
...
func (ctx *Ctx) SendGroupAIRecord(character string, groupID int64, text string) (string, error) {
	data, err := ctx.callActionData("send_group_ai_record", Params{
		"character": character,
		"group_id":  groupID,
		"text":      text,
	})
	...
	return data.Get("message_id").String(), nil
}

// SendPoke 群聊/私聊戳一戳
//
// https://napneko.github.io/develop/api/doc#send-poke-%E7%BE%A4%E8%81%8A-%E7%A7%81%E8%81%8A%E6%88%B3%E4%B8%80%E6%88%B3
func (ctx *Ctx) SendPoke(groupID, userID int64) error {
	return ctx.callActionOnly("send_poke", Params{
		"group_id": groupID,
		"user_id":  userID,
	})
}
...
func (ctx *Ctx) UploadPrivateFile(userID int64, file, name string) (string, error) {
	data, err := ctx.callActionData("upload_private_file", Params{
		"user_id": userID,
		"file":    file,
		"name":    name,
	})
	...
	return data.Get("file_id").Str, nil
}

// DeleteGroupFile 删除群文件
//
// https://napcat.apifox.cn/226658755e0.md
func (ctx *Ctx) DeleteGroupFile(groupID int64, fileID string) error {
	return ctx.callActionOnly("delete_group_file", Params{
		"group_id": groupID,
		"file_id":  fileID,
	})
}
...
func (ctx *Ctx) DeleteThisGroupFile(fileID string) error {
...
func (ctx *Ctx) CreateGroupFileFolder(groupID int64, folderName string) (gjson.Result, error) {
...
func (ctx *Ctx) CreateThisGroupFileFolder(folderName string) (gjson.Result, error) {
...
func (ctx *Ctx) DeleteGroupFileFolder(groupID int64, folderID string) error {
	return ctx.callActionOnly("delete_group_folder", Params{
		"group_id":  groupID,
		"folder_id": folderID,
	})
}
...
func (ctx *Ctx) DeleteThisGroupFileFolder(folderID string) error {
...
func (ctx *Ctx) DownloadFile(url, name, headers string) (string, error) {
	data, err := ctx.callActionData("download_file", Params{
		"url":     url,
		"name":    name,
		"headers": headers,
	})
	...
	return data.Get("file").Str, nil
}

// GetPrivateFileURL 获取私聊文件下载链接
//
// https://napcat.apifox.cn/266151849e0.md
func (ctx *Ctx) GetPrivateFileURL(fileID string) (string, error) {
	data, err := ctx.callActionData("get_private_file_url", Params{
		"file_id": fileID,
	})
	if err != nil {
		return "", err
...
func (ctx *Ctx) MoveGroupFile(groupID int64, fileID, parentFolderID, targetFolderID string) error {
	return ctx.callActionOnly("move_group_file", Params{
		"group_id":         groupID,
		"file_id":          fileID,
...
func (ctx *Ctx) RenameGroupFile(groupID int64, fileID, newName string) error {
	return ctx.callActionOnly("rename_group_file", Params{
		"group_id": groupID,
		"file_id":  fileID,
		"new_name": newName,
	})
...
func (ctx *Ctx) TransGroupFile(groupID int64, fileID, targetGroupID string) error {
	return ctx.callActionOnly("trans_group_file", Params{
		"group_id":        groupID,
		"file_id":         fileID,
...
func (ctx *Ctx) SendGroupNotice(groupID int64, content, image string, pinned int) error {
	return ctx.callActionOnly("_send_group_notice", Params{
		"group_id": groupID,
		"content":  content,
		"image":    image,
		"pinned":   pinned,
...
func (ctx *Ctx) SendThisGroupNotice(content, image string, pinned int) error {
...
func (ctx *Ctx) GetGroupNotice(groupID int64) (gjson.Result, error) {
...
func (ctx *Ctx) GetThisGroupNotice() (gjson.Result, error) {
...
func (ctx *Ctx) DeleteGroupNotice(groupID int64, noticeID string) error {
	return ctx.callActionOnly("_del_group_notice", Params{
		"group_id":  groupID,
		"notice_id": noticeID,
	})
}
...
func (ctx *Ctx) DeleteThisGroupNotice(noticeID string) error {
...
func (ctx *Ctx) DeleteFriend(userID int64, tempBlock, tempBothDel bool) error {
	return ctx.callActionOnly("delete_friend", Params{
		"user_id":       userID,
...
func (ctx *Ctx) SetFriendRemark(userID int64, remark string) error {
	return ctx.callActionOnly("set_friend_remark", Params{
		"user_id": userID,
		"remark":  remark,
	})
}
...
func (ctx *Ctx) GetUnidirectionalFriendList() (gjson.Result, error) {
...
func (ctx *Ctx) GetDoubtFriendsAddRequest() (gjson.Result, error) {
...
func (ctx *Ctx) SetDoubtFriendsAddRequest(flag string, approve bool, remark string) error {
	return ctx.callActionOnly("set_doubt_friends_add_request", Params{
		"flag":    flag,
		"approve": approve,
		"remark":  remark,
	})
...
//
// sex: 0=未知, 1=男, 2=女
func (ctx *Ctx) SetQQProfile(nickname, personalNote string, sex int) error {
	return ctx.callActionOnly("set_qq_profile", Params{
		"nickname":      nickname,
...
//
// eventType: 事件类型
func (ctx *Ctx) SetInputStatus(userID int64, eventType int) error {
	return ctx.callActionOnly("set_input_status", Params{
		"user_id":    userID,
...
func (ctx *Ctx) GetUserStatus(userID int64) (gjson.Result, error) {
...
func (ctx *Ctx) SetCustomOnlineStatus(faceID int, faceType int, wording string) error {
	return ctx.callActionOnly("set_custom_online_status", Params{
		"face_id":   faceID,
		"face_type": faceType,
		"wording":   wording,
	})
...
func (ctx *Ctx) GetGroupShutList(groupID int64) (gjson.Result, error) {
...
func (ctx *Ctx) GetThisGroupShutList() (gjson.Result, error) {
...
func (ctx *Ctx) GetGroupInfoEx(groupID int64) (gjson.Result, error) {
...
func (ctx *Ctx) GetThisGroupInfoEx() (gjson.Result, error) {
...
func (ctx *Ctx) SetGroupRemark(groupID int64, remark string) error {
	return ctx.callActionOnly("set_group_remark", Params{
		"group_id": groupID,
		"remark":   remark,
	})
}
...
func (ctx *Ctx) SetThisGroupRemark(remark string) error {
...
func (ctx *Ctx) GetGroupIgnoredNotifies(groupID int64) (gjson.Result, error) {
...
func (ctx *Ctx) GetThisGroupIgnoredNotifies() (gjson.Result, error) {
...
func (ctx *Ctx) SetGroupAddOption(groupID int64, addOption int) error {
	return ctx.callActionOnly("set_group_add_option", Params{
		"group_id":   groupID,
...
func (ctx *Ctx) SetGroupSearchOption(groupID int64, enabled bool) error {
	return ctx.callActionOnly("set_group_search_option", Params{
		"group_id": groupID,
		"enabled":  enabled,
	})
}
...
func (ctx *Ctx) GroupKickBatch(groupID int64, userIDs []int64, rejectAddRequest bool) error {
	return ctx.callActionOnly("set_group_kick", Params{
		"group_id":           groupID,
		"user_ids":           userIDs,
		"reject_add_request": rejectAddRequest,
...
func (ctx *Ctx) SetGroupTodo(groupID, messageID int64) error {
	return ctx.callActionOnly("set_group_todo", Params{
		"group_id":   groupID,
		"message_id": messageID,
	})
}
...
func (ctx *Ctx) SetThisGroupTodo(messageID int64) error {
...
func (ctx *Ctx) GetGroupAlbumList(groupID int64) (gjson.Result, error) {
...
func (ctx *Ctx) GetGroupAlbumMediaList(groupID int64, albumID string) (gjson.Result, error) {
...
func (ctx *Ctx) UploadGroupAlbum(groupID int64, albumID, file string) (gjson.Result, error) {
...
func (ctx *Ctx) DeleteGroupAlbumMedia(groupID int64, albumID, mediaID string) error {
	return ctx.callActionOnly("delete_group_album_media", Params{
		"group_id": groupID,
		"album_id": albumID,
		"media_id": mediaID,
	})
...
func (ctx *Ctx) LikeGroupAlbumMedia(groupID int64, albumID, mediaID string) error {
	return ctx.callActionOnly("like_group_album_media", Params{
		"group_id": groupID,
		"album_id": albumID,
		"media_id": mediaID,
	})
...
func (ctx *Ctx) SendGroupMusic(groupID int64, musicType string, id int64) (int64, error) {
	data, err := ctx.callActionData("send_group_msg", Params{
		"group_id": groupID,
...
func (ctx *Ctx) SendGroupCustomMusic(groupID int64, url, audio, title string) (int64, error) {
	data, err := ctx.callActionData("send_group_msg", Params{
		"group_id": groupID,
...
func (ctx *Ctx) GetEmojiLikeList(messageID interface{}, emojiID string, count int) (gjson.Result, error) {
...
func (ctx *Ctx) GetMiniAppArk(appID, title, desc, iconURL, webURL string) (gjson.Result, error) {
...
func (ctx *Ctx) CheckURLSafely(url string) (int64, error) {
	data, err := ctx.callActionData("check_url_safely", Params{
		"url": url,
	})
	if err != nil {
		return 0, err
	}
	return data.Get("level").Int(), nil
}

// CanSendImage 检查是否可以发送图片
//
// https://napcat.apifox.cn/226657071e0.md
func (ctx *Ctx) CanSendImage() (bool, error) {
	data, err := ctx.callActionData("can_send_image", Params{})
	if err != nil {
		return false, err
	}
	return data.Get("yes").Bool(), nil
}

// CanSendRecord 检查是否可以发送语音
//
// https://napcat.apifox.cn/226657080e0.md
func (ctx *Ctx) CanSendRecord() (bool, error) {
	data, err := ctx.callActionData("can_send_record", Params{})
	if err != nil {
		return false, err
	}
	return data.Get("yes").Bool(), nil
...
func (ctx *Ctx) GetCSRFToken() (int64, error) {
	data, err := ctx.callActionData("get_csrf_token", Params{})
	if err != nil {
		return 0, err
	}
	return data.Get("token").Int(), nil
}

// GetCredentials 获取登录凭证（Cookies + CSRF Token）
//
// https://napcat.apifox.cn/226657054e0.md
func (ctx *Ctx) GetCredentials(domain string) (gjson.Result, error) {
...
func (ctx *Ctx) GetCookies(domain string) (string, error) {
	data, err := ctx.callActionData("get_cookies", Params{
		"domain": domain,
	})
	if err != nil {
		return "", err
	}
	return data.Get("cookies").Str, nil
}

// GetClientKey 获取当前登录帐号的 ClientKey
//
// https://napcat.apifox.cn/250286915e0.md
func (ctx *Ctx) GetClientKey() (string, error) {
	data, err := ctx.callActionData("get_clientkey", Params{})
	if err != nil {
		return "", err
	}
	return data.Get("clientkey").Str, nil
}

// GetStatus 获取运行状态
//
// https://napcat.apifox.cn/226657083e0.md
func (ctx *Ctx) GetStatus() (gjson.Result, error) {
...
func (ctx *Ctx) CleanCache() error {
	return ctx.callActionOnly("clean_cache", Params{})
}

// Restart 重启服务
//
// https://napcat.apifox.cn/410334662e0.md
func (ctx *Ctx) Restart() error {
	return ctx.callActionOnly("set_restart", Params{})
}

// GetPacketStatus 获取Packet状态
//
// https://napcat.apifox.cn/226659280e0.md
func (ctx *Ctx) GetPacketStatus() (gjson.Result, error) {
...
func (ctx *Ctx) Logout() error {
	return ctx.callActionOnly("nc_logout", Params{})
}
...
func (ctx *Ctx) GetGuildList() (gjson.Result, error) {
...
func (ctx *Ctx) GetGuildServiceProfile() (gjson.Result, error) {
...
func (ctx *Ctx) GetRKey() (gjson.Result, error) {
...
func (ctx *Ctx) NcGetRKey() (gjson.Result, error) {
...
func (ctx *Ctx) GetRKeyServer() (gjson.Result, error) {
...
func (ctx *Ctx) ClickInlineKeyboardButton(groupID int64, botAppid string, buttonID, callbackData string) error {
	return ctx.callActionOnly("click_inline_keyboard_button", Params{
		"group_id":      groupID,
		"bot_appid":     botAppid,
		"button_id":     buttonID,
